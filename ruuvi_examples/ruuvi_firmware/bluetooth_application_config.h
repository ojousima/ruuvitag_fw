...
#define INIT_FWREV                      "RAWv2_slow_2.5.0"                         /**< Github tag. Do not include specifiers such as "alpha" so you can accept ready binaries as they are **/
...
#define ADVERTISING_INTERVAL_RAW      6000u
