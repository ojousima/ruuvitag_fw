...
#define BLE_COMPANY_IDENTIFIER          0x0499                            /**< Ruuvi Innovations Ltd. **/
...
#define APP_CFG_NON_CONN_ADV_INTERVAL_MS    MSEC_TO_UNITS(335, UNIT_0_625_MS) /**< The advertising interval for non-connectable advertisement (100 ms). This value can vary between 100 ms and 10.24 s). */
